...
Classify the answer using exactly one word:
- GROUNDED: fully supported by the documents
- PARTIAL: partly supported, with some extra information
- HALLUCINATED: not supported by the documents
